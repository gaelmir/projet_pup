function [Image,imagenames,posFix,posSaccStart,posSaccEnd,pvelSacc,blinkTime,AllTrialInfos,timeSaccStart,amplitudeSacc,VariablesNames,SaccDir,validSaccStartTime,validSaccPos,validNoBlink,nbBlinks,PPD_X,PPD_Y] = reshapeStruct_LK(structure,ExpeType)
