function [timeFixationCrossSample,timeBackgroundSample,timeImageSample,sizePupil,Image,imagenames,posFix,posSaccStart,posSaccEnd,pvelSacc,blinkTime,AllTrialInfos,timeSaccStart,amplitudeSacc,VariablesNames,SaccDir,validSaccStartTime,validSaccPos,validNoBlink,nbBlinks,PPD_X,PPD_Y] = reshapeStruct_LK(structure,ExpeType)
    ...
    if isempty(idxSacc{i}(:,1)) 
      ...
      %LK: coding of saccades validity
        ...
        validSaccPos{i}(1,2) = posSaccStart{i}(1,2)<= screenCenter(2)+...
            4*PPD_Y && posSaccStart{i}(1,2)>= screenCenter(2)-4*PPD_Y;
