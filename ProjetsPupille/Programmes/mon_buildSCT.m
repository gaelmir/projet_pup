function [sizePupil,Ttotal] = mon_buildSCT(SubjectCode,DataPath)
...
[sizePupil,Image,imagenames,posFix,posSaccStart,posSaccEnd,pvelSacc,blinkTime,...
    AllTrialInfos,timeSaccStart,amplitudeSacc,VariablesNames,SaccDir,...
    validSaccStartTime,validSaccPos,validNoBlink,nbBlinks] = ...
    recup_taille(eyedata,'SCT');
